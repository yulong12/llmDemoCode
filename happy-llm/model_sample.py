...
class TextGenerator:
    def __init__(self, 
                 checkpoint='./my_model_output/pretrain_1024_18_6144.pth',  # 模型检查点路径
        ...
        self.model = FangQi(ModelConfig(dim=1024, n_layers=18))  # 实例化 Transformer 模型
...
if __name__ == "__main__":
    ...
    generator = TextGenerator(checkpoint='./my_model_output/pretrain_1024_18_6144.pth')  # 初始化生成器
    ...
    generator = TextGenerator(checkpoint='./sft_model_215M_mps/sft_dim1024_layers18_vocab_size6144.pth')  # 初始化生成器
